    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('farmer_gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female')], max_length=10)),
                ('farmer_nin', models.CharField(max_length=20)),
                ('farmer_phone_number', models.CharField(max_length=15)),
                ('farmer_type', models.CharField(choices=[('Starter', 'Starter'), ('Returner', 'Returner')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sales_agent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sent_requests', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sender', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='pages.farmer')),
            ],
        ),
        migrations.CreateModel(
            name='Feedstock',
